...
const Hero = () => {
  ...
  return (
    <section className="w-full  h-full bg-bg-gray">
      <motion.div
        initial={{ y: "-100vh" }}
        animate={{
          y: 0,
        ...
        className="flex w-full  h-screen bg-hero-bg bg-no-repeat bg-cover justify-center cursor-default"
      >
      ...
      <AnimatePresence>
        {toggle && (
          <>
            ...
            >
              <NavContent setToggle={setToggle} />
      ...
      {/* Center Svg Icon */}
      {/* <motion.svg
        className={`absolute z-0 bottom-0 left-1/2 -translate-x-1/2`}
        width="100%"
        height="100%"
